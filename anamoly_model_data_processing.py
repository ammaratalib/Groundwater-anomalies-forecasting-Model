...
# start from here for temporal _temporal model calibration
os.chdir(r"C:\ammara_MD\paper3\Data\GW_anamoly_model\PCA_covariates_validation")
...
inv_y = scalery.inverse_transform(train_y)
# calculate RMSE
...
train_back["obs"]=inv_y
train_back["LSTM_model"]=inv_yhat
...
train_back.to_csv('df_temporal_train_results.csv', index=False, header=True)
